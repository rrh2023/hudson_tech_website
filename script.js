...
(function () {
  const translations = {
    en: {
      ...
      'hero.title3': 'forward',
      'hero.sub': 'Software & web development for Hudson County, NJ & beyond',
      ...
      'services.sub': 'Software development for Hudson County, NJ & beyond.',
      'services.valueHeading': 'The world has changed. Has your business?',
      ...
      'services.benefit5': '<strong>Make smarter decisions.</strong> Dashboards, analytics, and AI-powered insights turn the data you already collect into clear direction for your next move.',
      ...
      'about.leadBio': 'As the sole developer behind Hudson Technology Solutions, Roberto brings the engineering rigor he honed at Pinterest, PSEG, and PowerOptions directly to every client. No account managers, no offshore handoffs — just one senior engineer fully invested in your project from kickoff to launch.',

      'about.bio1': 'Hudson Technology Solutions is a <strong>solo software agency</strong> founded by <strong>Roberto Rodas-Herndon</strong>, a Boston University Computer Science graduate. While at Boston University, he served as <strong>President of the Hack4Impact chapter (2021–2023)</strong>, leading a student-run team that built free software for non-profits — the same mission that inspired the founding of our agency.',
      ...
      'timeline.desc1': 'Software development for Hudson County businesses & beyond.',
    ...
    es: {
      ...
      'hero.sub': 'Desarrollo de software y web para el condado de Hudson, NJ y más allá',
      ...
      'services.sub': 'Desarrollo de software para el condado de Hudson, NJ y más allá.',
      'services.valueHeading': 'El mundo cambió. ¿Y tu negocio?',
      ...
      'services.benefit5': '<strong>Toma decisiones más inteligentes.</strong> Paneles, analítica e inteligencia artificial convierten los datos que ya recopilas en una dirección clara para tu próxima decisión.',
      ...
      'timeline.desc1': 'Desarrollo de software para el condado de Hudson, NJ y más allá.',
