...
(function () {
  const translations = {
    en: {
      ...
      'hero.title3': 'forward.',
      'hero.sub': 'Custom web apps & software development for Hudson County businesses & beyond.',
      ...
      'services.sub': 'Custom web apps & software development for Hudson County businesses & beyond.',
    ...
    es: {
      ...
      'hero.sub': 'Aplicaciones web personalizadas y desarrollo de software para los negocios del condado de Hudson y más allá.',
      ...
      'services.sub': 'Aplicaciones web personalizadas y desarrollo de software para los negocios del condado de Hudson y más allá.',
